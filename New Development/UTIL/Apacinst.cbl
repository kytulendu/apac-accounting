   ...
   USING LS-PARID LS-USER-ID LS0-PROGRAMS LS0-SECURITY.
    ...
    IF WS-STATUS NOT = "00"
      ...
      /
       AC000-PARAM             SECTION.
       AC000-INIT.
          IF LS0-DTP = 2 OR LS0-STP = 2 OR LS0-CRP = 2 OR
             LS0-GLP = 2 OR LS0-HPD = 2 OR
   ...
   WITH FOREGROUND-COLOR 7 HIGHLIGHT
     ...
     TO PAR-DESC-H2.
      ...
      MOVE SEC-17CPI  TO W10-17CPI.
            MOVE W09-CONP  TO TRM-CONP (1)
                                    TRM-CONP (2).
            MOVE W09-NORP  TO TRM-NORP (1)
                                    TRM-NORP (2).
            MOVE W09-EXPP  TO TRM-EXPP (1)
                                    TRM-EXPP (2).
            MOVE W09-ECAN  TO TRM-ECAN (1)
                                    TRM-ECAN (2).
